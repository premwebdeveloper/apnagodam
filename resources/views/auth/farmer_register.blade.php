...
<section class="contact_form_area p-t-50">
    <div class="container">
        <div class="row contact_form_inner">
            <h3 class="c_inner_title">Seller Registration Form</h3>
            {!! Form::open(array('url' => 'farmer_registration', 'files' => true, 'class' => "contact_us_form")) !!}
                @csrf
