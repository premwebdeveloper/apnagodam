            ...
            <div class="ibox float-e-margins" id="print_data">
                <div class="ibox-content">
                    ...
                    <div class="row">
                        <div class="col-lg-12 m-t-20">
                            <div class="ibox">
                                <h3 class="f-s-20">Commodity Deposit Form</h3>
                                <ul class="list-unstyled file-list">
                                    <li class="col-md-2 f-s-14">File : <b>{!! ($case_gen->cdf_file)?'<a style="color:#1ab394;" href="'.url('/').'/resources/assets/upload/commodity_deposit/'.$case_gen->cdf_file.'" target="_blank">View</a>':'N/A' !!}</b></li>
                                    <li class="col-md-10 f-s-14">Notes : <b>{{ ($case_gen->t_p_notes)?$case_gen->t_p_notes:'N/A' }}</b></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 m-t-20">
                            <div class="ibox">
                                <h3 class="f-s-20">Warehouse Receipt</h3>
                                <ul class="list-unstyled file-list">
                                    <li class="col-md-2 f-s-14">File : <b>{!! ($case_gen->w_r_file)?'<a style="color:#1ab394;" href="'.url('/').'/resources/assets/upload/warehouse_receipt/'.$case_gen->w_r_file.'" target="_blank">View</a>':'N/A' !!}</b></li>
                                    <li class="col-md-10 f-s-14">Notes : <b>{{ ($case_gen->l_p_notes)?$case_gen->l_p_notes:'N/A' }}</b></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 m-t-20">
                            <div class="ibox">
                                <h3 class="f-s-20">Storage Receipt</h3>
                                <ul class="list-unstyled file-list">
                                    <li class="col-md-2 f-s-14">File : <b>{!! ($case_gen->s_r_file)?'<a style="color:#1ab394;" href="'.url('/').'/resources/assets/upload/storage_receipt/'.$case_gen->s_r_file.'" target="_blank">View</a>':'N/A' !!}</b></li>
                                    <li class="col-md-10 f-s-14">Notes : <b>{{ ($case_gen->l_p_notes)?$case_gen->l_p_notes:'N/A' }}</b></li>
                                </ul>
                            </div>
                        </div>
