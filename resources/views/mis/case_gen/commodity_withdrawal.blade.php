...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-6">
        <h2>Commodity Withdrawal Form</h2>
        <ol class="breadcrumb">
            <li>
                <a href="{{ route('dashboard') }}">Home</a>
            </li>
            <li class="active">
                <strong>Commodity Withdrawal Form</strong>
            </li>
        </ol>
    </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Commodity Withdrawal Form</h5>
                                ...
                                @foreach($case_gen as $key => $pricing)
                                    @if($pricing->in_out == 'OUT')
                                        ...
                                        <tr class="gradeX">
                                            <td>{{ ++$key }}</td>
                                            <td>
                                                @if($pricing->c_w_case_id)
                                                    <span class="text-navy">Done</span>
                                                @else
                                                    @if($role_id == 1 || $role_id == 7 || $role_id == 8)
                                                        @if($check_status)
                                                            <a data-id="{!! $pricing->case_id !!}" id='{!! $pricing->cust_fname." ".$pricing->cust_lname !!}' class="setPrice btn-warning btn btn-xs">Update CWF</a>
                                                        @else
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Upload Commodity Withdrawal Form</h4>
            </div>
            <div class="modal-body">
                ...
                {!! Form::open(array('url' => 'addCommodityWithdrawal', 'files' => true, 'class' => "contact_us_form", 'id' => 'empForm')) !!}
                    @csrf
                        ...
                        <div class="col-md-12">
                            <div class="col-md-4">
                                <div class="col-md-12 p-0">
                                    {!! Form::label('report_file', 'Commodity Withdrawal File', ['class' => 'm-t-20  col-form-label text-md-right']) !!}
