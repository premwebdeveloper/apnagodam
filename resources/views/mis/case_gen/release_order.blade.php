    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Upload Release Order</h4>
            </div>
            <div class="modal-body">
                ...
                {!! Form::open(array('url' => 'addReleaseOrder', 'files' => true, 'class' => "contact_us_form", 'id' => 'empForm')) !!}
                    @csrf
                        ...
                        <div class="col-md-12">
                            <div class="col-md-4">
                                <div class="col-md-12 p-0">
                                    {!! Form::label('report_file', 'Release Order File', ['class' => 'm-t-20  col-form-label text-md-right']) !!}
...
<div id="viewQualityReport" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Release Order File</h4>
            </div>
            <div class="modal-body">                
                <div class="row">
                    <div class="col-md-12">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('.view_report').on('click', function(){
            ...
            var full_url = "<?= url('/'); ?>/resources/assets/upload/release_order/"+file
