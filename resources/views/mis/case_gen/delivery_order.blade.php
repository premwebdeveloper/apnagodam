                            ...
                            <tbody>
                                ...
                                @foreach($case_gen as $key => $pricing)
                                    ...
                                    if($pricing->in_out == 'OUT'){
                                        $check_status = DB::table('apna_case_release_order')->where('case_id', $pricing->case_id)->first();
                                        ?>
                                        <tr class="gradeX">
                                            <td>{{ ++$key }}</td>
                                            <td>
                                                @if($pricing->d_o_case_id)
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Upload Delivery Order</h4>
            </div>
            <div class="modal-body">
                ...
                {!! Form::open(array('url' => 'addDeliveryOrder', 'files' => true, 'class' => "contact_us_form", 'id' => 'empForm')) !!}
                    @csrf
                        ...
                        <div class="col-md-12">
                            <div class="col-md-4">
                                <div class="col-md-12 p-0">
                                    {!! Form::label('report_file', 'Delivery Order File', ['class' => 'm-t-20  col-form-label text-md-right']) !!}
...
<div id="viewQualityReport" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Delivery Order File</h4>
            </div>
            <div class="modal-body">                
                <div class="row">
