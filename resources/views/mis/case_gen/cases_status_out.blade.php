	                        ...
	                        <tbody>
                                @foreach($case_gen as $key => $lead)
	                                <tr class="gradeX">
                                        ...
                                        <br>{{ ($lead->release_order_update_time)?date('g:i A', strtotime($lead->release_order_update_time)):'' }}
                                        <br/>
                                            {!! ($lead->release_order_file)?"<a class='view_file' data-id='release_order/".$lead->release_order_file."'><i class='fa fa-eye'></i></a>":'' !!}
                                    </td>
                                        <td>{!! ($lead->delivery_order_case_id)?'<span class="text-info">Completed</span>':'<span class="text-danger">Processing...</span>' !!}
                                        <br>{{ ($lead->delivery_order_update_time)?date('g:i A', strtotime($lead->delivery_order_update_time)):'' }}
                                        <br/>
                                            {!! ($lead->delivery_order_file)?"<a class='view_file' data-id='delivery_order/".$lead->delivery_order_file."'><i class='fa fa-eye'></i></a>":'' !!}
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <td>{!! ($lead->ivr_tagging_case_id)?'<span class="text-info">Completed</span>':'<span class="text-danger">Processing...</span>' !!}<br>{{ ($lead->ivr_tagging_update_time)?date('g:i A', strtotime($lead->ivr_tagging_update_time)):'' }}
                                            <br/>{!! ($lead->ivr_tagging_file)?"<a class='view_file' data-id='truck_payment/".$lead->ivr_tagging_file."'><i class='fa fa-eye'></i></a>":'' !!}
                                    </td>
                                        ...
                                        <br/>
                                            {!! ($lead->release_order_file)?"<a class='view_file' data-id='payment_received/".$lead->release_order_file."'><i class='fa fa-eye'></i></a>":'' !!}
                                    </td>
                                        ...
                                        <td>{!! date('d M Y', strtotime($lead->created_at)) !!}
                                        </td>
	                                </tr>
                                @endforeach
	                        </tbody>
