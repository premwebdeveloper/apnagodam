                                ...
                                @foreach($case_gen as $key => $pricing)
                                    @if($pricing->in_out == 'IN')
                                        ...
                                        <tr class="gradeX">
                                            <td>{{ ++$key }}</td>
                                            <td>
                                                @if($pricing->w_r_case_id)
                                                    <span class="text-navy">Done</span>
                                                @else
                                                    @if($role_id == 1 || $role_id == 3 || $role_id == 8)
                                                        @if($check_status)
                                                            <a data-id="{!! $pricing->case_id !!}" id='{!! $pricing->cust_fname." ".$pricing->cust_lname !!}' class="setPrice btn-warning btn btn-xs">Update Warehouse Receipt</a>
                                                        @else
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Upload Warehouse Receipt</h4>
            </div>
            <div class="modal-body">
                ...
                {!! Form::open(array('url' => 'addWarehouseReceipt', 'files' => true, 'class' => "contact_us_form", 'id' => 'empForm')) !!}
                    @csrf
...
<div id="viewQualityReport" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">WH Receipt File</h4>
            </div>
            <div class="modal-body">                
                <div class="row">
                    <div class="col-md-12">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('.view_report').on('click', function(){
            ...
            var full_url = "<?= url('/'); ?>/resources/assets/upload/warehouse_receipt/"+file
