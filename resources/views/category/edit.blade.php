                        ...
                        {!! Form::open(array('url' => 'edit_category', 'files' => true)) !!}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::number('gst', $category->gst, ['class' => 'form-control', 'id' => 'gst', 'placeholder' => 'GST on Sell', 'step' => '0.01']) !!}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::number('gst_on_rent', $category->gst_on_rent, ['class' => 'form-control', 'id' => 'gst_on_rent', 'placeholder' => 'GST on Rent', 'step' => '0.01']) !!}
