                ...
                {!! Form::open(array('url' => 'add_user', 'files' => true)) !!}
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                {!! Form::email('email', '', ['class' => 'form-control', 'id' => 'email', 'placeholder' => 'Email ID']) !!}
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                {!! Form::text('password_confirmation', '', ['class' => 'form-control', 'id' => 'password_confirmation', 'placeholder' => 'Confirm Password']) !!}
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                {!! Form::tel('phone', '', ['class' => 'form-control', 'id' => 'phone', 'placeholder' => 'First Name']) !!}
